...
def mask_seg(seg_file, seg_ds, mask_ds, out_ds=None, mask_file=None, out_file=None, mask_out=False):
    ...
    if success:
        print(f'{target_roi} from {seg_ds} masked with {mask_ds} and written to {out_file}/{out_ds}')
        return out
    else:
...
if __name__ == '__main__':
    kwargs = {}
    keys = ['seg_file', 'seg_ds', 'mask_ds', 'out_ds', 'mask_file', 'out_file', 'mask_out']
