...
def segment_myelin_in_block(
    ...
    for threshold in thresholds:
        ...
        ds_name = "volumes/clean0/3d/%s/myelin_segmentation" % merge_function + "_%.3f" % threshold
        if agglomerate_in_xy:
            ds_name = "volumes/clean0/2d/%s/myelin_segmentation" % merge_function + "_%.3f" % threshold
...
if __name__ == "__main__":
    ...
    affs_ds = "volumes/myelin_affs_clean0"
    ...
    fragments_ds = "volumes/3d/myelin_fragments"
    if agglomerate_in_xy:
        fragments_ds = "volumes/2d/myelin_fragments"
