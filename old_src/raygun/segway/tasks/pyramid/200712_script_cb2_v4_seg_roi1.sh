...
roi_offset='2800 540672 131072'
roi_shape='44000 344064 786432'
...
python segway/tasks/pyramid/task_scale_pyramid2.py $output_file $in_ds $output_file $out_ds --roi_offset $roi_offset --roi_shape $roi_shape --num_workers 64 --overwrite 2 --scale_factor ${scale_factor}
