...
f=/n/vast/htem/Segmentation/cb3_v1_test1/output.zarr
...
python segway/tasks/pyramid/task_scale_pyramid2.py $output_file $in_ds $output_file $out_ds --overwrite 2 --num_workers 2 --scheduling_block_size_mult 4 4 4
...
python segway/tasks/pyramid/task_scale_pyramid2.py $output_file $in_ds $output_file $out_ds --overwrite 2 --num_workers 2
