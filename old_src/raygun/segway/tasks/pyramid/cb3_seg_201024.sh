...
ds=volumes/super_1x2x2_segmentation_0.${i}00
output_file=/n/f810/htem/Segmentation/cb3_201019.n5
roi_offset='120 81920 81920'
roi_shape='20360 565248 827392'
...
python segway/tasks/pyramid/task_scale_pyramid2.py $output_file $in_ds $output_file $out_ds --roi_offset $roi_offset --roi_shape $roi_shape --overwrite 0 --num_workers 8 --scheduling_block_size_mult 4 4 4
...
python segway/tasks/pyramid/task_scale_pyramid2.py $output_file $in_ds $output_file $out_ds --roi_offset $roi_offset --roi_shape $roi_shape --overwrite 0 --num_workers 8
