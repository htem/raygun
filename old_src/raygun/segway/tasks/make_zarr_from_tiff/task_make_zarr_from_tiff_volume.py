...
class MakeZarrFromTiffTask(LaunchableDaisyTask):
    ...
    def worker_function(self, block):
        ...
        for num in sections: # TODO: REPLACE THIS WITH VOLUME SCRIPT
...
# TODO: FINISH THIS SECTION
    ...
    if len(sys.argv) > 1 and sys.argv[1] == 'run_worker':
        ...
        ap.add_argument("y_tile_size", type=int, help='In pixel')                       # TODO: GET FROM TIFF FILE
        ...
        ap.add_argument(
            ...
            nargs='+', default=None)
        ap.add_argument(                                                                 # TODO: GET FROM TIFF FILE
...
def make_zarr_from_tiff(src, args):
    img = Image.open(src)    
    task = MakeZarrFromTiffTask()
