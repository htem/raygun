...
source_file = '/n/balin_tank_ssd1/htem/Segmentation/cb2_v4/output.zarr'
source_ds = 'volumes/affs_mipmap/s2'

destination_file = '/n/groups/htem/ESRF_id16a/tomo_ML/ResolutionEnhancement/jlr54_tests/volumes/cb2/myelGCL1.n5'
destination_ds = 'volumes/affs_mipmap2'


offset = [8720, 382016, 460000] #IN WORLD UNITS (z,y,x)
