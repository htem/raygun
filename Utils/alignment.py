...
# %%
moving_file = '/n/groups/htem/ESRF_id16a/tomo_ML/ResolutionEnhancement/jlr54_tests/volumes/GT/CBvTopGT/CBxs_lobV_topm100um_eval_1_unaligned90nm.n5'
moving_name = 'volumes/raw_90nm'
moving_ds = daisy.open_ds(moving_file, moving_name)
moving_array = moving_ds.to_ndarray()

fixed_file = '/n/groups/htem/ESRF_id16a/tomo_ML/ResolutionEnhancement/jlr54_tests/volumes/GT/CBvTopGT/CBxs_lobV_topm100um_eval_1.n5'
...
elx.SetParameterMap(parameterMapVector)
