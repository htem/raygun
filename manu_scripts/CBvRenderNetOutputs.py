...
if __name__ == '__main__':
    # python CBvRenderNetOutputs.py <Path to Training Script> <cycle> <side_length> <checkpoint1> ... <checkpointN>
    ...
    for checkpoint in sys.argv[4:]:
        ...
        cycleGun.render_full(side_length=int(sys.argv[3]), side='A', cycle=(sys.argv[2].lower() == 'true'), label_dict=label_dict)#, crop_to_valid=True)
        print(f"Rendered!")
