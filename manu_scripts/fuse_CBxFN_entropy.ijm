// // ~/fiji --headless --console -macro /n/groups/htem/users/jlr54/raygun/manu_scripts/fuse_CBxFN_entropy.ijm '/n/groups/htem/ESRF_id16a/LTP/cb_FN_lobX_feb2021/jlr54/fullres/ cbX_FN_90nm_fullres.xml cbX_FN_90nm_fullres-fuseEntropy.xml'
...
// ~/fiji  --headless -macro /n/groups/htem/users/jlr54/raygun/manu_scripts/fuse_CBxFN_entropy.ijm
basePath = "/n/groups/htem/ESRF_id16a/LTP/cb_FN_lobX_feb2021/jlr54/fullres/";
in_file = "cbX_FN_90nm_fullres.xml";
out_file = "cbX_FN_90nm_fullres-fuseEntropy.xml";
...
run("Fuse dataset ...",
    ...
    " image=[Cached] blend use produce=[All views together] fused_image=[Save as new XML Project (HDF5)] " +
    "subsampling_factors=[{ {1,1,1} }] " + 
    "hdf5_chunk_sizes=[{ {16,16,16} }] use_deflate_compression " +
