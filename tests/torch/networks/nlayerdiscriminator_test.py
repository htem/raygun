import unittest
import torch
from raygun.torch.networks.NLayerDiscriminator2D import *
...
class TestNLayerDiscriminator2D(unittest.TestCase):
    ...
    def test_fov(self):
        ...
        # Check that the FOV is within the expected range (this is an example range)
        expected_fov = 70
        self.assertGreaterEqual(fov, expected_fov - 1)
        self.assertLessEqual(fov, expected_fov + 1)
