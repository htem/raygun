...
class NotACycleGAN(BaseSystem):
    def __init__(self, config=None):
        super().__init__(
            default_config="../default_configs/default_NaC_conf.json", config=config
        )
    ...
    def setup_optimization(self):
        self.optimizer_D = get_base_optimizer(self.d_optim_type)(
            self.netD.parameters(), **self.d_optim_kwargs
        )
        ...
        self.optimizer_G = get_base_optimizer(self.g_optim_type)(
            itertools.chain(*[net.parameters() for net in self.model.NaC_nets]),
            **self.g_optim_kwargs
        )
