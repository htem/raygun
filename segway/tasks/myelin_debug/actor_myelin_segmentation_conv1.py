...
def segment_myelin_in_block(
    ...
    for threshold in thresholds:
        ...
        ds_name = "volumes/conv1/3d/%s/myelin_segmentation" % merge_function + "_%.3f" % threshold
        if agglomerate_in_xy:
            ds_name = "volumes/conv1/2d/%s/myelin_segmentation" % merge_function + "_%.3f" % threshold
...
if __name__ == "__main__":
    ...
    affs_ds = "volumes/myelin_pred_conv1"
