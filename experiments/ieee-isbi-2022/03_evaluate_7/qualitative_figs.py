...
dataset_dict_list = [
    ...
    {  # Train on Real 30nm, Predict on Link-Fake 30nm
        ...
        "/nrs/funke/rhoadesj/raygun/experiments/ieee-isbi-2022/03_evaluate_7/train_real/30nm/predict_link/seed13/eval_1.n5": {
            "Predicted\nLocal Shape\nDescriptors": "pred_lsds",
            "Predicted\nAffinities": "pred_affs",
            "Predicted\nSegmentation": "segment",
        },
    ...
    {  # Train on Real 30nm, Predict on Split-Fake 30nm
        ...
        "/nrs/funke/rhoadesj/raygun/experiments/ieee-isbi-2022/03_evaluate_7/train_real/30nm/predict_split/seed42/eval_1.n5": {
            "Predicted\nLocal Shape\nDescriptors": "pred_lsds",
            "Predicted\nAffinities": "pred_affs",
            "Predicted\nSegmentation": "segment",
        },
    ...
    {  # Train on Real 30nm, Predict on Real 90nm
        ...
        "/nrs/funke/rhoadesj/raygun/experiments/ieee-isbi-2022/03_evaluate_7/train_real/30nm/predict_real/90nm/eval_1.n5": {
            "Predicted\nLocal Shape\nDescriptors": "pred_lsds",
            "Predicted\nAffinities": "pred_affs",
            "Predicted\nSegmentation": "segment",
        },
    ...
    {  # Train on Real 90nm, Predict on Real 90nm
        ...
        "/nrs/funke/rhoadesj/raygun/experiments/ieee-isbi-2022/03_evaluate_7/train_real/90nm/predict_real90nm/eval_1.n5": {
            "Predicted\nLocal Shape\nDescriptors": "pred_lsds",
            "Predicted\nAffinities": "pred_affs",
            "Predicted\nSegmentation": "segment",
        },
    ...
    {  # Train on Split-Fake 90nm, Predict on Real 90nm
        ...
        "/nrs/funke/rhoadesj/raygun/experiments/ieee-isbi-2022/03_evaluate_7/train_split/seed42/predict_real90nm/eval_1.n5": {
            "Predicted\nLocal Shape\nDescriptors": "pred_lsds",
            "Predicted\nAffinities": "pred_affs",
            "Predicted\nSegmentation": "segment",
        },
